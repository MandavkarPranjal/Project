...
void hotel:: manager(){
    ...
    if(inputpassM == PasswordM){
        ...
        cout << "Total Rooms availabe : " << Trooms - Srooms << endl;
        ...
        switch(choice){
            ...
            {   system("cls");
                ...
                if(Irooms > Trooms){
                    ...
                    cout << "Price per room : " << Prooms << endl;
                    cout << "Total price: " << Irooms * Prooms << endl;
                    ...
                    if (confirm1 ==1){
                        ...
                        cout << "You have canceled your order" << endl;
                        Irooms=0;
            ...
            case 2:
            {
                ...
                if(Ipasta > Tpasta){
                    ...
                    cout << "Price per unit : " << Ppasta << endl;
                    cout << "Total price: " << Ipasta * Ppasta << endl;
                    cout << "Do you want to coufirm your order? \n1. Yes \n2. No" << endl;
                    cout << "Enter your choice: ";
                    int confirm2{};
                    cin >> confirm2;
            ...
            case 3:
            {
                ...
                if(Isalad > Tsalad){
                    ...
                    cout << "Price per unit : " << Psalad << endl;
                    cout << "Total price: " << Isalad * Psalad << endl;
                    cout << "Do you want to coufirm your order? \n1. Yes \n2. No" << endl;
                    cout << "Enter your choice: ";
                    int confirm3{};
                    cin >> confirm3;
            ...
            case 4:
            {
                ...
                if(Iburger > Tburger){
                    ...
                    cout << "Price per unit : " << Pburger << endl;
                    cout << "Total price: " << Iburger * Pburger << endl;
                    cout << "Do you want to coufirm your order? \n1. Yes \n2. No" << endl;
                    cout << "Enter your choice: ";
                    int confirm4{};
                    cin >> confirm4;
            ...
            case 5:
            {
                ...
                if(Ipizaa > Tpizaa){
                    ...
                    cout << "Price per unit : " << Ppizaa << endl;
                    cout << "Total price: " << Ipizaa * Ppizaa << endl;
                    cout << "Do you want to coufirm your order? \n1. Yes \n2. No" << endl;
                    cout << "Enter your choice: ";
                    int confirm5{};
                    cin >> confirm5;
            ...
            case 6:
            {
                ...
                if(Ichicken > Tchicken){
                    ...
                    cout << "Price per uniit : " << Pchicken << endl;
                    cout << "Total price: " << Ichicken * Pchicken << endl;
                    cout << "Do you want to coufirm your order? \n1. Yes \n2. No" << endl;
                    cout << "Enter your choice: ";
                    int confirm6{};
                    cin >> confirm6;
                    if (confirm6 ==1){
                        ...
                        tempChicken = tempChicken - Schicken;
                    }
                    else if(confirm6 == 2){
                        cout << "You have canceled your order" << endl;
                        Ichicken=0;
            ...
            case 7:
            {
                ...
                if(Inoodle > Tnoodle){
                    ...
                    cout << "Price per unit : " << Pnoodle << endl;
                    cout << "Total price: " << Inoodle * Pnoodle << endl;
                    cout << "Do you want to coufirm your order? \n1. Yes \n2. No" << endl;
                    cout << "Enter your choice: ";
                    int confirm7{};
                    cin >> confirm7;
